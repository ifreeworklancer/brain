...
(function () {
  ...
  $('ul.directions-content-list').on('click', 'li:not(.active)', function () {
    $(this).addClass('active').siblings().removeClass('active').closest('div.directions-content').find('div.directions-content-item').removeClass('active animated zoomIn').eq($(this).index()).addClass('active animated zoomIn');
  });
  ...
  $('ul.course-open-item-nav-list').on('click', 'li:not(.active)', function () {
    $(this).addClass('active').siblings().removeClass('active').closest('div.course-open-item').find('div.course-open-item-content').removeClass('active animated slideInLeft').eq($(this).index()).addClass('active animated slideInLeft');
  });
})(jQuery);
